...
class MPERunner(Runner):
    ...
    def collect(self, step):
        ...
        value, action, action_log_prob, rnn_states, rnn_states_critic \
            = self.trainer.policy.get_actions(self.addNosie(np.concatenate(self.buffer.share_obs[step])),
                            self.addNosie(np.concatenate(self.buffer.obs[step])),
    ...
    def eval(self, total_num_steps):
        ...
        for eval_step in range(self.episode_length):
            self.trainer.prep_rollout()
            eval_action, eval_rnn_states = self.trainer.policy.act(self.addNosie(np.concatenate(eval_obs)),
